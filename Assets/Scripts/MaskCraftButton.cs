...
{
    [Header("UI")]
    public Button craftButton;              // 拖你的 Button 进来

    [Header("Templates")]
    public EmotionTraitID emotionTrait;    // 测试时配词条进来，实际游玩过程需要再加代码判断是什么词条（许可写）
    ...
    private void OnCraftClicked()
    {
        ...
        var instance = new MaskInstance(Guid.NewGuid().ToString("N"), "红色开心面具",emotionTrait,memoryTrait,colorTrait);
        if (warehouse == null)
        {
